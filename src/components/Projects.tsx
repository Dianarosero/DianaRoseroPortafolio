              ...
              <div className="aspect-video overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                  <div className="flex gap-3">
                    <a
                      href={project.demo}
                      className="p-2 rounded-full bg-primary text-background hover:scale-110 transition-transform"
                      target="_blank"
                    ...
                    <a
                      href={project.github}
                      className="p-2 rounded-full bg-white/20 backdrop-blur-md text-foreground hover:scale-110 transition-transform"
                      target="_blank"
                      rel="noreferrer noopener"
